...
c ***
c
      character*90 name1,name2,string
      character*80 name,getunx
      integer*4 iret
      logical exists
      integer unlink
...
c
      ...
      dflast=33.d0   ! used to be 33
      dffirst=0.1d0
      dfgrav=100.
      lfirst=2
      llast=2000
      dprecis=1.d-7   ! used to be -7
      ngren=7! number of mode branches to be computed
c
      do jcom=2,3
...
c-- ngren = nbran defines how many branches to compute
...
c THIS IS WERE THE OUTPUT IS WRITTEN TO SCREEN.
      print 200,nord,ichar(jcom),l,b,wmhz,tcom,gcom,qmod,wdiff
c      print*,nord,ichar(jcom),l,b,wmhz,tcom,gcom,qmod,wdiff
